...
public partial class CrewManager : Node
{
	...
	private void SpawnCaskets()
	{
		...
		Node column1 = playspace.GetNodeOrNull("CanvasLayer/PlayerShip/Portrait/Pivot//Caskets/Column1");
		Node column2 = playspace.GetNodeOrNull("CanvasLayer/PlayerShip/Portrait/Pivot//Caskets/Column2");
